...
public class ApexVariableDefinitionImpl extends ASTWrapperPsiElement implements ApexVariableDefinition {

  public ApexVariableDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
