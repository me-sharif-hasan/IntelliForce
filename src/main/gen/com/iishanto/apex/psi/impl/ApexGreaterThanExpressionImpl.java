...
public class ApexGreaterThanExpressionImpl extends ApexExpressionImpl implements ApexGreaterThanExpression {

  public ApexGreaterThanExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
