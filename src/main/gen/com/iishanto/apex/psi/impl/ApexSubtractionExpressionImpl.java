...
public class ApexSubtractionExpressionImpl extends ApexExpressionImpl implements ApexSubtractionExpression {

  public ApexSubtractionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
