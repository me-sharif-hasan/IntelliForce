...
public class ApexIdentifierExpressionImpl extends ApexExpressionImpl implements ApexIdentifierExpression {

  public ApexIdentifierExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
