...
public class ApexGenericExpressionImpl extends ApexExpressionImpl implements ApexGenericExpression {

  public ApexGenericExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
