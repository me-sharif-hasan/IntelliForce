...
public class ApexBitwiseAndExpressionImpl extends ApexExpressionImpl implements ApexBitwiseAndExpression {

  public ApexBitwiseAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
