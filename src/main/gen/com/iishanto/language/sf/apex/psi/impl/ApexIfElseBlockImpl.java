...
public class ApexIfElseBlockImpl extends ASTWrapperPsiElement implements ApexIfElseBlock {

  public ApexIfElseBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ApexIfStatement getIfStatement() {
    return findNotNullChildByClass(ApexIfStatement.class);
  }
