...
public class ApexLogicalNotEqualEqualExprImpl extends ApexExpressionImpl implements ApexLogicalNotEqualEqualExpr {

  public ApexLogicalNotEqualEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
