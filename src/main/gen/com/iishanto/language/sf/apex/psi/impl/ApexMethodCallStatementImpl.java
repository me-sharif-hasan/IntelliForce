...
public class ApexMethodCallStatementImpl extends ASTWrapperPsiElement implements ApexMethodCallStatement {

  public ApexMethodCallStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
