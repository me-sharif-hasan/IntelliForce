...
public class ApexMemberModifierImpl extends ASTWrapperPsiElement implements ApexMemberModifier {

  public ApexMemberModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ApexMemberAccessModifier getMemberAccessModifier() {
    return findChildByClass(ApexMemberAccessModifier.class);
  }
