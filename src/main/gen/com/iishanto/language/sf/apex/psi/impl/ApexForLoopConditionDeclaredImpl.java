...
public class ApexForLoopConditionDeclaredImpl extends ASTWrapperPsiElement implements ApexForLoopConditionDeclared {

  public ApexForLoopConditionDeclaredImpl(@NotNull ASTNode node) {
    super(node);
  }
