...
public class ApexUnaryPostfixIncrementExprImpl extends ApexExpressionImpl implements ApexUnaryPostfixIncrementExpr {

  public ApexUnaryPostfixIncrementExprImpl(@NotNull ASTNode node) {
    super(node);
  }
