...
public class ApexLogicalEqualEqualExprImpl extends ApexExpressionImpl implements ApexLogicalEqualEqualExpr {

  public ApexLogicalEqualEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
