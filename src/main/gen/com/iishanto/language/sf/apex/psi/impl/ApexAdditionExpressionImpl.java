...
public class ApexAdditionExpressionImpl extends ApexExpressionImpl implements ApexAdditionExpression {

  public ApexAdditionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
