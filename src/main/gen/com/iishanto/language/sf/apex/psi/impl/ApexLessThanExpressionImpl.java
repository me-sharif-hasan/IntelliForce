...
public class ApexLessThanExpressionImpl extends ApexExpressionImpl implements ApexLessThanExpression {

  public ApexLessThanExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
