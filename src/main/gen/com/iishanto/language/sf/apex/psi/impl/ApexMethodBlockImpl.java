...
public class ApexMethodBlockImpl extends ASTWrapperPsiElement implements ApexMethodBlock {

  public ApexMethodBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ApexMethodBody getMethodBody() {
    return findNotNullChildByClass(ApexMethodBody.class);
  }
