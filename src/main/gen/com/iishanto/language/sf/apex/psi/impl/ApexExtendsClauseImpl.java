...
public class ApexExtendsClauseImpl extends ASTWrapperPsiElement implements ApexExtendsClause {

  public ApexExtendsClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ApexClassOrInterfaceReference getClassOrInterfaceReference() {
    return findNotNullChildByClass(ApexClassOrInterfaceReference.class);
  }
