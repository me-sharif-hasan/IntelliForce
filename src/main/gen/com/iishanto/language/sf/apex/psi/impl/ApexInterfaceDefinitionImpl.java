...
public class ApexInterfaceDefinitionImpl extends ASTWrapperPsiElement implements ApexInterfaceDefinition {

  public ApexInterfaceDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
