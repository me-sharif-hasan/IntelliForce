...
public class ApexInterfaceIdentifierImpl extends ASTWrapperPsiElement implements ApexInterfaceIdentifier {

  public ApexInterfaceIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
