...
public class ApexDoWhileLoopImpl extends ASTWrapperPsiElement implements ApexDoWhileLoop {

  public ApexDoWhileLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ApexDoBlock getDoBlock() {
    return findNotNullChildByClass(ApexDoBlock.class);
  }
