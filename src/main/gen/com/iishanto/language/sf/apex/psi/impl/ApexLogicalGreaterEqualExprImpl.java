...
public class ApexLogicalGreaterEqualExprImpl extends ApexExpressionImpl implements ApexLogicalGreaterEqualExpr {

  public ApexLogicalGreaterEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
