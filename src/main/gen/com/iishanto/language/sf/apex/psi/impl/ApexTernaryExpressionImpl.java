...
public class ApexTernaryExpressionImpl extends ApexExpressionImpl implements ApexTernaryExpression {

  public ApexTernaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
