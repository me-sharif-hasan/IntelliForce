...
public class ApexLogicalGreaterExprImpl extends ApexExpressionImpl implements ApexLogicalGreaterExpr {

  public ApexLogicalGreaterExprImpl(@NotNull ASTNode node) {
    super(node);
  }
