...
public class ApexOrAssignExpressionImpl extends ApexExpressionImpl implements ApexOrAssignExpression {

  public ApexOrAssignExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ApexVisitor visitor) {
    visitor.visitOrAssignExpression(this);
  }
