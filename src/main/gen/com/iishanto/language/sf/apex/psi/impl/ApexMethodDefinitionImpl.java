...
public class ApexMethodDefinitionImpl extends ASTWrapperPsiElement implements ApexMethodDefinition {

  public ApexMethodDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
