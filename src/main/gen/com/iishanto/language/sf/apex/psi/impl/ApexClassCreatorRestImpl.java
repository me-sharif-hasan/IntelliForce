...
public class ApexClassCreatorRestImpl extends ASTWrapperPsiElement implements ApexClassCreatorRest {

  public ApexClassCreatorRestImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ApexArguments getArguments() {
    return findNotNullChildByClass(ApexArguments.class);
  }
