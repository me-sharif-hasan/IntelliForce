...
public class ApexEqualityExpressionImpl extends ApexExpressionImpl implements ApexEqualityExpression {

  public ApexEqualityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
