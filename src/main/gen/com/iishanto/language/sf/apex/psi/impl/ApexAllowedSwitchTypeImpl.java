...
public class ApexAllowedSwitchTypeImpl extends ASTWrapperPsiElement implements ApexAllowedSwitchType {

  public ApexAllowedSwitchTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
