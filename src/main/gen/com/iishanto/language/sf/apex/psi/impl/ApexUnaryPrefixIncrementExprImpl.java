...
public class ApexUnaryPrefixIncrementExprImpl extends ApexExpressionImpl implements ApexUnaryPrefixIncrementExpr {

  public ApexUnaryPrefixIncrementExprImpl(@NotNull ASTNode node) {
    super(node);
  }
