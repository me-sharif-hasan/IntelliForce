...
public class ApexIncrementBeforeExpressionImpl extends ApexExpressionImpl implements ApexIncrementBeforeExpression {

  public ApexIncrementBeforeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ApexVisitor visitor) {
    visitor.visitIncrementBeforeExpression(this);
  }
