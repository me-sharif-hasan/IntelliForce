...
public class ApexBitwiseOrExpressionImpl extends ApexExpressionImpl implements ApexBitwiseOrExpression {

  public ApexBitwiseOrExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
