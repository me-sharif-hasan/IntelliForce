...
public class ApexSwitchWhenValueListImpl extends ASTWrapperPsiElement implements ApexSwitchWhenValueList {

  public ApexSwitchWhenValueListImpl(@NotNull ASTNode node) {
    super(node);
  }
