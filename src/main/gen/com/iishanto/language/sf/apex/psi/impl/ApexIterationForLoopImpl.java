...
public class ApexIterationForLoopImpl extends ASTWrapperPsiElement implements ApexIterationForLoop {

  public ApexIterationForLoopImpl(@NotNull ASTNode node) {
    super(node);
  }
