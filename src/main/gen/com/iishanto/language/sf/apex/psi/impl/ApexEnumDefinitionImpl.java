...
public class ApexEnumDefinitionImpl extends ASTWrapperPsiElement implements ApexEnumDefinition {

  public ApexEnumDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ApexEnumBody getEnumBody() {
    return findNotNullChildByClass(ApexEnumBody.class);
  }
