...
public class ApexGreaterEqualExpressionImpl extends ApexExpressionImpl implements ApexGreaterEqualExpression {

  public ApexGreaterEqualExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
