...
public class ApexInequalityExpressionImpl extends ApexExpressionImpl implements ApexInequalityExpression {

  public ApexInequalityExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
