...
public class ApexLoopControlStatementImpl extends ASTWrapperPsiElement implements ApexLoopControlStatement {

  public ApexLoopControlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
