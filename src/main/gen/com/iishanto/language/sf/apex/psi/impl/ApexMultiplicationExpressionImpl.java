...
public class ApexMultiplicationExpressionImpl extends ApexExpressionImpl implements ApexMultiplicationExpression {

  public ApexMultiplicationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
