...
public class ApexUnaryPostfixDecrementExprImpl extends ApexExpressionImpl implements ApexUnaryPostfixDecrementExpr {

  public ApexUnaryPostfixDecrementExprImpl(@NotNull ASTNode node) {
    super(node);
  }
