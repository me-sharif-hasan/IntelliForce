...
public class ApexMethodNameWithArgumentImpl extends ASTWrapperPsiElement implements ApexMethodNameWithArgument {

  public ApexMethodNameWithArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ApexVisitor visitor) {
    visitor.visitMethodNameWithArgument(this);
  }
