...
public class ApexInstanceOfExpressionImpl extends ApexExpressionImpl implements ApexInstanceOfExpression {

  public ApexInstanceOfExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
