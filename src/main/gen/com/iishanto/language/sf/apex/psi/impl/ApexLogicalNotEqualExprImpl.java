...
public class ApexLogicalNotEqualExprImpl extends ApexExpressionImpl implements ApexLogicalNotEqualExpr {

  public ApexLogicalNotEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
