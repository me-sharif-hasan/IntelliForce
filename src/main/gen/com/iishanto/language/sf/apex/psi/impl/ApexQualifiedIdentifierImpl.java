...
public class ApexQualifiedIdentifierImpl extends ASTWrapperPsiElement implements ApexQualifiedIdentifier {

  public ApexQualifiedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
