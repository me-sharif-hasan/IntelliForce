...
public class ApexDivisionExpressionImpl extends ApexExpressionImpl implements ApexDivisionExpression {

  public ApexDivisionExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
