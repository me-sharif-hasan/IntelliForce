...
public class ApexSwitchBlockBodyImpl extends ASTWrapperPsiElement implements ApexSwitchBlockBody {

  public ApexSwitchBlockBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ApexVisitor visitor) {
    visitor.visitSwitchBlockBody(this);
  }
