...
public class ApexLogicalLessEqualExprImpl extends ApexExpressionImpl implements ApexLogicalLessEqualExpr {

  public ApexLogicalLessEqualExprImpl(@NotNull ASTNode node) {
    super(node);
  }
