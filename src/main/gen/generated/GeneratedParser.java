...
public class GeneratedParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // TypeIdentifier VariableName LBRACE (GET_KEYWORD|SET_KEYWORD) SEMICOLON (GET_KEYWORD|SET_KEYWORD) SEMICOLON RBRACE
  public static boolean GetterSetterDefinition(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "GetterSetterDefinition")) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, GETTER_SETTER_DEFINITION, "<getter setter definition>");
    r = TypeIdentifier(b, l + 1);
    r = r && VariableName(b, l + 1);
    r = r && consumeToken(b, LBRACE);
    r = r && GetterSetterDefinition_3(b, l + 1);
    r = r && consumeToken(b, SEMICOLON);
    r = r && GetterSetterDefinition_5(b, l + 1);
    r = r && consumeTokens(b, 0, SEMICOLON, RBRACE);
    exit_section_(b, l, m, r, false, null);
    return r;
  }

  // GET_KEYWORD|SET_KEYWORD
  private static boolean GetterSetterDefinition_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "GetterSetterDefinition_3")) return false;
    boolean r;
    r = consumeToken(b, GET_KEYWORD);
    if (!r) r = consumeToken(b, SET_KEYWORD);
    return r;
  ...
  // GET_KEYWORD|SET_KEYWORD
  private static boolean GetterSetterDefinition_5(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "GetterSetterDefinition_5")) return false;
    boolean r;
    r = consumeToken(b, GET_KEYWORD);
    if (!r) r = consumeToken(b, SET_KEYWORD);
    return r;
