...
public class SfApexLogicalGreaterExprImplementation extends SfApexExpressionImplementation implements SfApexLogicalGreaterExpr {

  public SfApexLogicalGreaterExprImplementation(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SfApexVisitor visitor) {
    visitor.visitLogicalGreaterExpr(this);
  }
