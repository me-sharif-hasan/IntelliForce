...
public class SfApexSwitchWhenValueListImplementation extends ASTWrapperPsiElement implements SfApexSwitchWhenValueList {

  public SfApexSwitchWhenValueListImplementation(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SfApexVisitor visitor) {
    visitor.visitSwitchWhenValueList(this);
  }
