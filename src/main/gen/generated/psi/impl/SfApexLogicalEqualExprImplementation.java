...
public class SfApexLogicalEqualExprImplementation extends SfApexExpressionImplementation implements SfApexLogicalEqualExpr {

  public SfApexLogicalEqualExprImplementation(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SfApexVisitor visitor) {
    visitor.visitLogicalEqualExpr(this);
  }
