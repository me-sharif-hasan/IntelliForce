...
public class SfApexLogicalLessExprImplementation extends SfApexExpressionImplementation implements SfApexLogicalLessExpr {

  public SfApexLogicalLessExprImplementation(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SfApexVisitor visitor) {
    visitor.visitLogicalLessExpr(this);
  }
