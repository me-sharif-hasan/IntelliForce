...
public class SfApexWhileBodyImplementation extends ASTWrapperPsiElement implements SfApexWhileBody {

  public SfApexWhileBodyImplementation(@NotNull ASTNode node) {
    super(node);
  }
