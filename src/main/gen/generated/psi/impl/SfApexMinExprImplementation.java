...
public class SfApexMinExprImplementation extends SfApexExpressionImplementation implements SfApexMinExpr {

  public SfApexMinExprImplementation(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull SfApexVisitor visitor) {
    visitor.visitMinExpr(this);
  }
